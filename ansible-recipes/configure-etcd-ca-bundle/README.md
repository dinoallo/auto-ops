...
This recipe updates kubeadm-style static pod manifests so kube-apiserver and etcd trust the staged etcd CA bundle at `/etc/kubernetes/pki/etcd/ca-bundle.crt`.
...
4. Configures kube-apiserver with `--etcd-cafile=/etc/kubernetes/pki/etcd/ca-bundle.crt`.
5. Configures etcd with `--trusted-ca-file=/etc/kubernetes/pki/etcd/ca-bundle.crt`.
6. Configures etcd with `--peer-trusted-ca-file=/etc/kubernetes/pki/etcd/ca-bundle.crt`.
...
- Existing etcd CA bundle at `/etc/kubernetes/pki/etcd/ca-bundle.crt`
...
- `etcd_ca_bundle_path`: etcd CA bundle path, defaults to `'/etc/kubernetes/pki/etcd/ca-bundle.crt'`
