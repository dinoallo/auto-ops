...
9. Verifies the managed static pod manifest arguments.
10. Prints the certificate count, subject, issuer, validity dates, and SHA256 fingerprint for the active CA certificate.
